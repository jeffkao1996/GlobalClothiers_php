...
<head>
    ...
    <title>Global Clothiers|Women|Activewear|Scrunched Leg Cargo Pants</title>
            ...
            <table border="0">
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <div class="product">
                            <img src="https://ats-sb.adobe.com/jjsite/include/images/active4.jpg" class="photo" width="300" border="0" />
                            <br />
...
<button type=submit onclick="simpleCart.add('name=Scrunched Leg Cargo Pants','price=650.00','image=https://ats-sb.adobe.com/jjsite/include/active4.jpg');" name="addToCart" value="100233" class="button">ADD TO CART</button>
</form>
</span>

...
<head>
    ...
    <title>Global Clothiers|Men|Fine Apparel|French Cuff Shirt</title>
        ...
        <div id="wrapper">
            ...
            <table border="0">
                <tr>
                    <td valign="top">
                        <div class="product">
                            <img src="https://ats-sb.adobe.com/jjsite/include/images/man-apparel3.jpg" class="photo" width="300" border="0" />
                            <br />
...
<button type=submit onclick="simpleCart.add('name=French Cuff Shirt','price=309.99','image=https://ats-sb.adobe.com/jjsite/include/man-apparel2.jpg');" name="addToCart" value="201244" class="button">ADD TO CART</button>
</form>
</span>
                    <p />
...
<a href="https://ats-sb.adobe.com/jjsite/include/downloads/mens_shirt_size_conversion.pdf" 
